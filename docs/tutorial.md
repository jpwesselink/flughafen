...
Get a type-safe GitHub Actions workflow running in 2 minutes.
...
- [Examples](./examples.md) - More workflow patterns
- [Reverse Engineering](./reverse-engineering-quick-start.md) - Convert YAML to TypeScript
