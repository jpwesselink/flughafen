...
if (import.meta.vitest) {
  ...
  describe('WorkflowScanner', () => {
    ...
    it('should get unique owners', () => {
      ...
      const actions: ActionReference[] = [
        { action: 'actions/checkout@v4', owner: 'actions', name: 'checkout', version: 'v4', usageContexts: [] },
        { action: 'actions/setup-node@v4', owner: 'actions', name: 'setup-node', version: 'v4', usageContexts: [] },
        { action: 'aws-actions/configure-aws-credentials@v2', owner: 'aws-actions', name: 'configure-aws-credentials', version: 'v2', usageContexts: [] },
        { action: 'my-org/custom-action@v1', owner: 'my-org', name: 'custom-action', version: 'v1', usageContexts: [] }
      ];
