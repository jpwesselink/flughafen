...
import { type EnhancedWorkflowContext, type ExpressionValidationResult, ExpressionValidator } from "./validator";
...
export class TypeAwareExpressionValidator extends ExpressionValidator {
	...
	private extractActionReferences(expression: string): string[] {
		...
		let match;
		while ((match = stepOutputPattern.exec(expression)) !== null) {
