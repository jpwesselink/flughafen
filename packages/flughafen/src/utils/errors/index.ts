...
export const createBuilderConfigurationError = (field: string, value: any, reason: string): BuilderConfigurationError => {
  return new BuilderConfigurationError(
...
export const createSandboxExecutionError = (operation: string, details: string, cause?: Error): SandboxExecutionError => {
